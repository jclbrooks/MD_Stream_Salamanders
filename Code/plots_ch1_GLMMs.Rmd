...
ggplot(sallies_long, aes(x = type, y = value)) + geom_boxplot(fill = "lightblue") + theme_classic() + xlab("Stream Type") + ylab("Individuals/Transect") + facet_wrap(~species, nrow = 2, ncol = 3)  + theme(text = element_text(family = "Times New Roman", size = 15),axis.text.x = element_text(size = 15),
...
ggplot(sallies_all, aes(x = mean_wetted_width + cobble, DMON)) + geom_point() + geom_smooth(data = sallies_all, method = "glm", formula = y ~ exp(x)) + theme_classic()

ggplot(sallies_all, aes(x = mean_wetted_width , DMON)) + geom_point() + geom_smooth(data = sallies_all, method = "glm", formula = y ~ exp(x))  + theme(text = element_text(family = "Times New Roman", size = 15),axis.text.x = element_text(size = 15),
        axis.text.y = element_text(size = 15),
        axis.title.x = element_text(size = 20, margin = margin(t = 20, r = 0, b = 0, l = 0)),
        axis.title.y = element_text(size = 20, margin = margin(t = 0, r = 20, b = 0, l = 0)),
        axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank()) + 
  xlab("Mean Wetted Width (m)") + ylab("DMON Counts") + xlim(0,6) + ylim(-1,12)

ggplot(sallies_all, aes(x = cobble , DMON)) + geom_point() + geom_smooth(data = sallies_all, method = "glm", formula = y ~ exp(x))  + theme(text = element_text(family = "Times New Roman", size = 15),axis.text.x = element_text(size = 15),
        axis.text.y = element_text(size = 15),
        axis.title.x = element_text(size = 20, margin = margin(t = 20, r = 0, b = 0, l = 0)),
        axis.title.y = element_text(size = 20, margin = margin(t = 0, r = 20, b = 0, l = 0)),
        axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank()) + 
  xlab("Percent Cobble") + ylab("DMON Counts") + xlim(0,100) + ylim(-1,12)
...
ggplot(sallies_all, aes(x = pH , EBIS)) + geom_point() + geom_smooth(data = sallies_all, method = "glm", formula = y ~ exp(x))  + theme(text = element_text(family = "Times New Roman", size = 15),axis.text.x = element_text(size = 15),
        axis.text.y = element_text(size = 15),
        axis.title.x = element_text(size = 20, margin = margin(t = 20, r = 0, b = 0, l = 0)),
        axis.title.y = element_text(size = 20, margin = margin(t = 0, r = 20, b = 0, l = 0)),
        axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank()) + 
  xlab("pH") + ylab("EBIS Counts") + xlim(4,9) + ylim(-1,12)
```


## USE THIS ONE
```{r, sallies - percent sand, echo = FALSE, message=FALSE, warning=FALSE}
ggplot(sallies_all, aes(x = cobble , GPOR)) + geom_point() + geom_smooth(data = sallies_all, method = "glm", formula = y ~ exp(x))  + theme(text = element_text(family = "Times New Roman", size = 15),axis.text.x = element_text(size = 15),
        axis.text.y = element_text(size = 15),
        axis.title.x = element_text(size = 20, margin = margin(t = 20, r = 0, b = 0, l = 0)),
        axis.title.y = element_text(size = 20, margin = margin(t = 0, r = 20, b = 0, l = 0)),
        axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank()) + 
  xlab("Percent Cobble") + ylab("GPOR Counts") + xlim(0,100) + ylim(-1,8)
```
...
ggplot(sallies, aes(x = up_down, y = pH)) + geom_boxplot(fill = "lightblue") + xlab("Section of Stream") + theme(text = element_text(family = "Times New Roman", size = 15),axis.text.x = element_text(size = 15, color = "black"),
        ...
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
        panel.background = element_blank()) + scale_x_discrete(labels = c("Upstream", "Downstream", "Reference"))
```
...
ggplot(sallies, aes(x = up_down, y = EC)) + geom_boxplot(fill = "lightblue") + xlab("Section of Stream") + theme(text = element_text(family = "Times New Roman", size = 15),axis.text.x = element_text(size = 15, color = "black"),
        axis.text.y = element_text(size = 15, color = "black"),
        axis.title.x = element_text(size = 20, margin = margin(t = 20, r = 0, b = 0, l = 0)),
        axis.title.y = element_text(size = 20, margin = margin(t = 0, r = 20, b = 0, l = 0)),
        axis.line = element_line(colour = "black"),
        ...
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
        panel.background = element_blank()) + scale_x_discrete(labels = c("Upstream", "Downstream", "Reference")) + ylab("Electrical Conductivity (μS)")
...
ggplot(sallies_long, aes(x = up_down, y = value)) + geom_boxplot(fill = "lightblue") + theme_classic() + xlab("Stream Section") + ylab("Individuals/Transect") + facet_wrap(~species, nrow = 2, ncol = 3)  + theme(text = element_text(family = "Times New Roman", size = 15, color = "black"),axis.text.x = element_text(size = 15, angle = 45, hjust = 1, color = "black"),
        axis.text.y = element_text(size = 15),
        axis.title.x = element_text(size = 20, margin = margin(t = 20, r = 0, b = 0, l = 0)),
        axis.title.y = element_text(size = 20, margin = margin(t = 0, r = 20, b = 0, l = 0)),
        axis.line = element_line(colour = "black"),
